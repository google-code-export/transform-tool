package com.vstyran.transform.operations
{
	...
	public class AnchorOperation extends BaseOperation
	{
		 ...
		 * @private 
		 */		
		protected var _startAnchor:Point;

		/**
		 * Anchor point at the moment of starting transformation. 
		 */
		public function get startAnchor():Point
		{
			return _startAnchor;
		}
									   ...
									   snappingFunction:Function = null):void
		{
			...
			if(anchor)
				_startAnchor = new Point(anchor.x*startData.width, anchor.y*startData.height);
			else
				_startAnchor =  MathUtil.floorPoint(new Point(startData.width/2, startData.height/2));	
		}
	}
}