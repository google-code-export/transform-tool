package com.vstyran.transform.events
{
	...
	public class TransformEvent extends Event
	{
		 ...
		 * @private 
		 */		
		private var _isUserAction:Boolean = true;
		
		/**
		 * Flag that indicates whether transformation was initiated by user action on current transform tool.
		 */		
		public function get isUserAction():Boolean
		{
			return _isUserAction;
		}
		 ...
		 * @param isUserAction Flag that indicates whether transformation was initiated by user action on current transform tool.
		 */		
		public function TransformEvent(type:String, transformationType:String,  toolData:DisplayData = null, data:DisplayData = null, isUserAction:Boolean = true)
		{
			super(type);
